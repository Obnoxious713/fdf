...
** setting the values (0,0) (1,1) and (2,2) of smat to the cordinates passed in
** and (3, 3) to 1. The product of the matrices is then stored
** in matrix
*/
