...
void 		ft_vect_mult_mat(t_3d *vect, float mat[4][4], t_3d *data)
{
	...
	x = ((vect->x * mat[0][0]) + (vect->y * mat[1][0]) + (vect->z * mat[2][0]) + mat[3][0]);
	y = ((vect->x * mat[0][1]) + (vect->y * mat[1][1]) + (vect->z * mat[2][1]) + mat[3][1]);
	z = ((vect->x * mat[0][2]) + (vect->y * mat[1][2]) + (vect->z * mat[2][2]) + mat[3][2]);
	data->x = x;
	data->y = y;
	data->z = z;
}
